...
test('models.json declares both Flex models under the openai-flex provider', () => {
  ...
  assert.ok(provider.models['gpt-5.6-luna'], 'openai-flex must declare gpt-5.6-luna')
  assert.ok(provider.models['gpt-5.6-terra'], 'openai-flex must declare gpt-5.6-terra')
  assert.equal(provider.models['gpt-5.6-luna'].reasoning, true)
  assert.equal(provider.models['gpt-5.6-terra'].reasoning, true)
})
