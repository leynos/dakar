 ...
 * onto every pi Flex adapter before every run. A timed-out adapter
...
export const PI_FLEX_ADAPTERS = Object.freeze([
  'pi-luna-flex',
  'pi-luna-flex-medium',
  'pi-luna-flex-high',
  'pi-terra-flex',
 ...
 * only the pi Flex adapters gain a `timeout` (in seconds) and every other
