...
NODE_MODULES := bin/dakar-review.mjs scripts/build-workflow.mjs scripts/check-docstrings.mjs scripts/live-review-harness.mjs scripts/review-config.mjs scripts/review-state.mjs tests/cli.test.mjs tests/live-harness.test.mjs tests/compile-time-contract.test.mjs tests/docstrings.test.mjs tests/review-config.test.mjs tests/review-state.test.mjs tests/review-state.property.test.mjs tests/review-state.robustness.test.mjs tests/workflow-build.test.mjs tests/workflow-candidate-paths.test.mjs tests/workflow-dry-run.test.mjs tests/workflow-retry.test.mjs tests/workflow-task-graph.test.mjs
