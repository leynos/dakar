...
- WI-1/WI-2 at 2026-07-14 02:18Z: the scrutineer independently passed all four
  ...
  findings.
- WI-3 at 2026-07-14 05:14Z: the scrutineer passed `make check-fmt`,
  `make typecheck`, `make lint`, and `make test`; 83 tests passed. Repeated
  CodeRabbit passes cleared all applicable findings, with conflicting or
